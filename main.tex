...
\usepackage{sjtu-bachelor-proposal}
...
\section{课题研究目的和意义（含国内外研究现状综述）：}

制作本开题报告 \LaTeX{} 模板的初衷，是为校友们提供一个比传统 Word 更专业的排版方案。
...
\subsection{永动机} \label{perpetual_motion}

针对本课题所涉及的核心动力来源，我们并未局限于传统的物理框架，而是试图在逻辑层面构建一套永恒且自洽的循环体系。

\subsubsection{能量守恒定律的绕过策略}

在处理永动机的理论模型时，研究的难点不在于如何产生能量，而在于如何说服能量不要平白无故地流失。在文献 \cite{MAGNET_CAR} 中提到的磁性加速实验中已有部分理论依据。
...
\section{研究方法和研究思路（技术路线）：}

此处填写你的研究方法和研究思路（技术路线）。
